...
//     if (!email || !amount) {
//       return ApiResponse.error(res, 'Email and amount are required', 400);
//     }
...
//     const MAX_AMOUNT = 1000000; // ₦1,000,000
    
//     if (numericAmount < MIN_AMOUNT) {
//       return ApiResponse.error(res, `Minimum funding amount is ₦${MIN_AMOUNT}`, 400);
//     }
    
//     if (numericAmount > MAX_AMOUNT) {
//       return ApiResponse.error(res, `Maximum funding amount is ₦${MAX_AMOUNT}`, 400);
//     }

//     const reference = generateReference();
//     console.log('Initializing payment:', { userId, amount: numericAmount, reference });

//     // Check for existing pending transaction with same amount for this user
...
//       return ApiResponse.error(res, 'You have a pending transaction. Please complete or wait for it to expire.', 400);
//     }
...
//       { userId, transactionType: 'WALLET_FUNDING' } // Additional metadata
//     );
...
//     return ApiResponse.error(res, 'Failed to initialize payment. Please try again.', 500);
//   }
// };

// /**
//  * Webhook handler for Paystack payment verification
//  */
...
// /**
//  * Manual payment verification (callback endpoint)
//  */
// exports.verifyAndCreditWallet = async (req, res) => {
//   try {
//     const { reference, trxref } = req.query.reference ? req.query : req.body;
...
//       return ApiResponse.error(res, 'Transaction has already failed', 400);
//     }

//     // Verify with Paystack
//     const paystackData = await paystackService.verifyPayment(paymentReference);
//     await this.processPaymentVerification(transaction, paystackData.data);

//     const updatedWallet = await Wallet.findOne({ userId: transaction.userId });
...
//     return ApiResponse.error(res, 'Payment verification failed. Please contact support.', 500);
//   }
// };
...
//   await this.creditWallet(transaction, amount / 100); // Convert kobo to naira
// };

// /**
//  * Process failed payment
//  */
// exports.processFailedPayment = async (paymentData) => {
...
//  */
// exports.processPaymentVerification = async (transaction, paymentData) => {
//   const { status, amount, gateway_response } = paymentData;
...
//     await this.creditWallet(transaction, amountInNaira);
//   } else {
...
//  * Credit user wallet
//  */
// exports.creditWallet = async (transaction, amount) => {
//   try {
...
// controllers/walletController.js - DEBUG VERSION
const Wallet = require('../models/Wallet');
const Transaction = require('../models/Transaction');
const paystackService = require('../services/paystackService');
const { generateReference } = require('../utils/helpers');
